...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
  subroutine test_time_interpolation()
    ...
    open(10, file='time_interpolation.dat')
    ...
    write(10,*) 'plot "time_interpolation.dat" using 1:2 with points linetype 1 pointtype 2 title "Interpolation",\'
    write(10,*) '     "structure_evolution.dat" using 1:(10**$2) with lines title "Profile"'

    write(11,*) 'plot "time_interpolation.dat" using 1:3 with points linetype 1 pointtype 2 title "Interpolation",\'
    write(11,*) '     "structure_evolution.dat" using 1:(10**$3) with lines title "Profile"'

    write(12,*) 'plot "time_interpolation.dat" using 1:4 with points linetype 1 pointtype 2 title "Interpolation",\'
    write(12,*) '     "structure_evolution.dat" using 1:(10**$4) with lines title "Profile"'

    write(12,*) 'plot "time_interpolation.dat" using 1:5 with points linetype 1 pointtype 2 title "Interpolation",\'
    write(12,*) '     "structure_evolution.dat" using 1:(10**$5) with lines title "Profile"'
