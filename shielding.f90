...
integer, parameter :: NL1=105
integer, parameter :: NL2=52
integer, parameter :: NL3=43


! H2 Shielding factors
! NH2 (cm-2)
real(double_precision), parameter, dimension(nl1) :: N1H2 = (/0.000d+00, 3.690d+11, &
3.715d+12, 3.948d+13, 1.233d+14, 2.536d+14, 4.342d+14, 6.653d+14, 6.689d+14, &
...
! teta H2
real(double_precision), parameter, dimension(nl1) :: T1H2 = (/1.000d+00, 9.983d-01, 9.853d-01, &
8.761d-01, 7.199d-01, 5.728d-01, 4.455d-01, 3.431d-01, 3.418d-01, &
...
! NCO (cm-2)
real(double_precision), parameter, dimension(nl2) :: N2CO = (/ 0.000d+00, 1.000d+12, &
1.650d+12, 2.995d+12, 5.979d+12, 1.313d+13, 3.172d+13, 8.429d+13, 2.464d+14, &
...
! Teta CO
real(double_precision), parameter, dimension(nl2) :: T2CO = (/ 1.000d+00, 9.990d-01, &
9.981d-01, 9.961d-01, 9.912d-01, 9.815d-01, 9.601d-01, 9.113d-01, 8.094d-01, &
...
!NH2 (cm-2)
real(double_precision), parameter, dimension(nl3) :: N2H2 = (/0.000d+00, 2.666d+13, &
3.801d+14, 6.634d+15, 8.829d+16, 9.268d+17, 1.007d+18, 2.021d+18, 3.036d+18, &
...
! Teta H2
real(double_precision), parameter, dimension(nl3) :: T2H2 = (/1.000d+00, 9.999d-01, &
9.893d-01, 9.678d-01, 9.465d-01, 9.137d-01, 9.121d-01, 8.966d-01, 8.862d-01, &
...
! AV
real(double_precision), parameter, dimension(nl3) :: AV2 = (/0.000d+00, 1.000d-07, &
1.000d-06, 1.000d-05, 1.000d-04, 1.000d-03, 1.086d-03, 2.171d-03, 3.257d-03, &
...
! teta AV
real(double_precision), parameter, dimension(nl3) :: T2AV = (/1.000d+00, 1.000d+00, &
1.000d+00, 1.000d+00, 9.991d-01, 9.887d-01, 9.877d-01, 9.755d-01, 9.638d-01, &
