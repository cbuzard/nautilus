...
write(35) gas_temperature, 0.5d0 * H_number_density, TAU1D, X_IONISATION_RATE1D
write(35) abundances
close(35)
...
&", TAU=",0PF8.3,", ZETA=",1PD10.3," s-1")') 00,00,TIME,H_number_density,gas_temperature,TAU,CR_IONISATION_RATE
