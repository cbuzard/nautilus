...
detailled in \refsec{sec:input-files}. This program will generate binary outputs that are not readable by default.
...
Then \gras[binary!nautilus\_outputs]{nautilus\_outputs}. And then the other two if you want.
\end{remarque}
